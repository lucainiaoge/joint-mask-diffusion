...
dataset_dir = "ProstateMRI" # change according to your project
dataset = ProstateTianfei(base_path=dataset_dir, image_size=image_size, train_ratio=0.8, split='test', transform=None, gray=gray)
